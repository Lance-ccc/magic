...
(window.webpackJsonp = window.webpackJsonp || []).push([[6], {
    "06d8846050cfb57dcd78": function (e, t, n) {
        "use strict";
        var c = n("98bae3dbabd51089d613"), r = n("275976081ce1abf67779"), a = n("b912ecc4473ae8a2ff0b"), i = n.n(a),
            u = n("49a47d064cfbf2949ee5"), o = function (e) {
                var t = e.prefixCls, n = e.type, a = e.size, o = e.color,
                    s = Object(c.f)(e, ["prefixCls", "type", "size", "color"]);
                u(!!n, "type should be required for icon");
                var l = i()(t, t + "-" + n), d = {color: o};
                return a && (d.fontSize = a), r.createElement("i", Object(c.a)({className: l, style: d}, s))
            };
        o.defaultProps = {
        ...
        var c = n("98bae3dbabd51089d613"), r = n("275976081ce1abf67779"), a = n.n(r), i = n("8880da179a969fe34488"),
            ...
            s = function () {
                return a.a.createElement("div", {className: "nodata"}, a.a.createElement(o.a, {
                    ...
                    color: "#DDD",
                    size: 60
                }), a.a.createElement("div", {className: "text"}, "暂无记录"))
            }, l = n("d7e9eb5549c8706aa74e"), d = n("7324f8fb03a95b5e63cb"), f = function (e) {
                d.f.show({
                    content: a.a.createElement(m, {type: l.f.FAILURE, content: e}),
                    duration: e.length > 30 ? 1e4 : e.length > 10 ? 5e3 : 2e3
                })
            }, m = function (e) {
                var t = e.content, n = e.type;
                return a.a.createElement("div", {className: "toast-content-container"}, a.a.createElement("img", {
                ...
                }), a.a.createElement("span", {className: "toast-content"}, t))
            }, A = n("99a69097ed1720fbb78e"), b = function (e) {
                var t = e.locations, n = e.centerOfficeTypeId, r = e.sbuId, i = e.handleChange, u = e.lastTimeOrgLocationId,
                ...
                return u && t.forEach((function (e) {
                ...
                }, a.a.createElement("div", {className: "location-select"}, s.map((function (e) {
                    ...
                    }, a.a.createElement("div", {className: "bu"}, e.sbuName || "集中办公区"), a.a.createElement("div", {className: "address"}, e.address)))
                })))))
            }, v = function (e) {
                var t = e.selectedIndex, n = e.projects, c = e.detail, r = e.status, i = e.handleSelectProject,
                    u = e.handleClickProjectItem, o = e.handleSelectStatus, s = e.handleInputReason;
                return a.a.createElement(a.a.Fragment, null, a.a.createElement("span", {className: "project-title"}, "选择今日实际工作项目"), a.a.createElement("div", {className: "project-container"}, a.a.createElement(d.d.Group, {
                    defaultValue: l.d.PARTICIPATED,
                    onChange: o
                }, a.a.createElement("div", {className: "project-type"}, a.a.createElement(d.d, {
            ...
            }, E = n("85ab163692c101fef3ae"), I = function (e) {
                var t = e.item, n = e.handleDesc;
                return a.a.createElement("div", {className: "card"}, a.a.createElement("section", null, a.a.createElement("img", {
                    src: E.a,
                    className: "bord"
                }), a.a.createElement("div", {className: "title"}, a.a.createElement("span", {className: "time"}, G(t.createTime).format("YYYY-MM-DD HH:mm:ss")), a.a.createElement("span", {className: "project"}, t.projectCode)), a.a.createElement("div", {className: "location"}, t.realLocation), t.remark && t.remark.length > 0 && a.a.createElement("div", {
                    className: "remark",
                    onClick: function () {
                        return n && n(t.remark)
                    }
            ...
            }, g = n("4d3cb4cbcd1efe604c5a"), C = n("c1ff5b6cec5f671be822"), S = n.n(C), j = n("7d8545d2807e9743ca01"),
            y = n.n(j), T = n("da010f21fea25912dd9e"), k = n.n(T), w = n("90122cf3021eb6001234"),
        ...
        var U = function (e) {
            ...
            }, a.a.createElement("div", {className: "content-container"}, a.a.createElement("div", {className: "left-container"}, n.filter((function (e, t) {
                return t % 2 == 0
            })).map((function (e) {
                return a.a.createElement("div", {className: "check-item"}, a.a.createElement(d.d, {
                    value: e.id,
                    icon: A.a,
                    style: {"--icon-size": "10px"}
                }, e.sceneName))
            }))), a.a.createElement("div", {className: "right-container"}, n.filter((function (e, t) {
                return t % 2 == 1
            })).map((function (e) {
                return a.a.createElement("div", {className: "check-item"}, a.a.createElement(d.d, {
                    value: e.id,
            ...
            }))))), v && a.a.createElement("div", {className: "checkin-common"}, a.a.createElement(d.e, {
                placeholder: s,
                rows: 3,
                onChange: u
            })))
        ...
        var G = Object(w.extendMoment)(k.a), F = {startTime: "8:30", endTime: "19:30", mustCheckinTimes: []}, B = [],
            V = y()(), Y = l.b.BUSINESS_TRIP;
        ...
        t.default = function () {
            var e = this, t = Object(r.useRef)(), n = Object(r.useRef)(F), A = Object(r.useRef)(B),
                ...
                T = Object(r.useRef)(null), k = Object(c.e)(Object(r.useState)(!1), 2), w = k[0], R = k[1],
                z = Object(c.e)(Object(r.useState)(!1), 2), Q = z[0], W = z[1],
                X = Object(c.e)(Object(r.useState)(), 2), J = X[0], x = X[1], K = Object(r.useRef)(),
                q = Object(r.useRef)(void 0), Z = Object(r.useRef)(void 0), _ = Object(c.e)(Object(r.useState)(!1), 2),
                $ = _[0], ee = _[1], te = Object(c.e)(Object(r.useState)(!0), 2), ne = te[0], ce = te[1],
                re = Object(r.useRef)(null), ae = Object(c.e)(Object(r.useState)(!1), 2), ie = ae[0], ue = ae[1],
                oe = Object(c.e)(Object(r.useState)([]), 2), se = oe[0], le = oe[1],
                de = Object(c.e)(Object(r.useState)(!1), 2), fe = de[0], me = de[1],
                Ae = Object(c.e)(Object(r.useState)(!1), 2), be = Ae[0], ve = Ae[1],
                Ee = Object(c.e)(Object(r.useState)(""), 2), Ie = Ee[0], pe = Ee[1],
                Oe = Object(c.e)(Object(r.useState)(!1), 2), he = Oe[0], Ne = Oe[1],
                ge = Object(c.e)(Object(r.useState)(!1), 2), Ce = ge[0], Se = ge[1],
                je = Object(c.e)(Object(r.useState)(l.d.PARTICIPATED), 2), ye = je[0], Te = je[1],
                ke = Object(c.e)(Object(r.useState)([]), 2), we = ke[0], De = ke[1],
                Me = Object(c.e)(Object(r.useState)(-1), 2), Re = Me[0], Pe = Me[1],
           ...
           alert(JSON.stringify(J));
                ...
                !function () {
                    ...
                    return Object(c.b)(e, void 0, void 0, (function () {
                        ...
                        return Object(c.d)(this, (function (t) {
                            return e = h(), g.a.openURL({url: e + "/hint"}), [2]
                        }))
                    }))
                }))
            }), []);
            var We = function () {
                return Object(c.b)(e, void 0, void 0, (function () {
                    ...
                    return Object(c.d)(this, (function (c) {
                        switch (c.label) {
                            case 0:
                                return re.current ? (e = re.current.deviceId, !/(iPhone|iPad|iPod|iOS)/i.test(navigator.userAgent) && It(Et(), "8.0.2") < 0 ? [4, Object(u.e)({deviceId: e})] : [3, 2]) : [2];
                            case 1:
                        ...
                        return [2, new Promise((function (e) {
                            t.current = d.b.show({
                                content: a.a.createElement(U, {
                                    ...
                                    })), type: l.a.TIME, handleInput: dt, handleChange: lt
                                }), actions: _e(e)
                            })
                        }))]
                    }))
                        ...
                        return [2, new Promise((function (e) {
                            t.current = d.b.show({
                                content: a.a.createElement(U, {
                                    ...
                                    })), type: l.a.SCOPE, handleChange: lt, handleInput: dt
                                }), actions: _e(e)
                            })
                        }))]
                    }))
                ...
                var e = !0, t = y()(), c = y()(t.format("YYYY-MM-DD ") + n.current.startTime),
                ...
                for (var t = !1, c = y()(), r = 0; r < e.length; r++) {
                    var a = e[r], i = y()(c.format("YYYY-MM-DD ") + a.startTime);
                                ...
                                if (i = c.sent(), o = i.resultCode, s = i.data, "000000" === o) {
                                    if (f = [], s.map((function (e) {
                                        return e.distance = function (e, t, n, c) {
                                            var r = e * Math.PI / 180, a = n * Math.PI / 180,
                                                i = (e - n) * Math.PI / 180, u = (t - c) * Math.PI / 180,
            ...
            function It(e, t) {
                var n, c, r = /(\.0+)+$/, a = e.replace(r, "").split("."), i = t.replace(r, "").split("."),
                    u = Math.min(a.length, i.length);
                for (n = 0; n < u; n++) if (c = parseInt(a[n], 10) - parseInt(i[n], 10)) return c;
                    ...
                    return Object(c.d)(this, (function (c) {
                        switch (c.label) {
                            case 0:
                                ...
                                c.label = 1;
                            case 1:
                                return c.trys.push([1, 3, , 4]), n = {keywords: e.projectCode}, [4, Object(u.d)(n)];
                            case 2:
                    ...
                    return Object(c.d)(this, (function (u) {
                        switch (u.label) {
                            ...
                            case 1:
                                ...
                                }(n, j.current, {acceptService: t}), P.a.setItem("lsolationList", i)) : (a.push({
                                    nt: j.current,
                                    acceptService: t
            ...
            return a.a.createElement(a.a.Fragment, null, a.a.createElement("div", {className: "home-container"}, a.a.createElement("div", {className: "home-container-scroll"}, a.a.createElement("div", {className: "top-container"}, a.a.createElement("div", {className: "location-container"}, bt() ? a.a.createElement(o.a, {
                type: "dingwei",
                color: "#48BE36",
                size: 20
                    ...
                    !function (t) {
                        g.a.registerNotification(l.e, (function (n) {
                            ...
                            if (void 0 === n && (n = !1), -1 != window.navigator.userAgent.indexOf("kara")) {
                                var c = window.kara;
                                c && c.openURL({url: h() + e, replace: n ? 1 : 0})
            ...
            }), a.a.createElement("div", {className: "content-container"}, a.a.createElement("div", {
                className: "work-order",
                onClick: function () {
                    var e = "https://apps.asiainfo.com/cms/resources/ai_trip/zh_cn/content_603313117.html";
                    -1 != window.navigator.userAgent.indexOf("kara") ? window.kara && g.a.openURL({url: e}) : window.location.replace(e)
                }
            }, a.a.createElement(o.a, {
                type: "wenhao",
                color: "#999",
                ...
                visible: fe,
                content: a.a.createElement(p, {text: Ie}),
                closeOnAction: !0,
                onClose: function () {
                    me(!1)
                },
        ...
        var c = n("275976081ce1abf67779"), r = n.n(c), a = n("06d8846050cfb57dcd78"), i = function (e) {
        ...
        var c = n("2ed98e28bd39a71ea784"), r = n("8880da179a969fe34488"), a = n("d7b9a318decb73da5108");
